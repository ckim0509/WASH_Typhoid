...
pp_check(Water_Source_Improve)
pp_check(Water_Source_Surface_water)
pp_check(Water_Treatment_Treated_water)
pp_check(Water_Treatment_Untreated_water)
pp_check(Sanitation_Open_defecation)
pp_check(Hygiene_Basic)
pp_check(Hygiene_Limited)
